...
#include "AdminMenu.h"
#include "ConfirmationHelper.h"
#include "Console.h"
#include "AllStaticVariables.h"
...
void Start()
{
	...
	std::shared_ptr<Admin> admin_1(new Admin("Kenan", "admin"));
	std::shared_ptr<Admin> admin_2(new Admin("Teymur", "123456"));
	std::shared_ptr<Admin> admin_3(new Admin("Haji", "HajiIsHere"));
	...
	std::shared_ptr<Restaurant> restaurant(new Restaurant("welcome to the world baby", "It's Kenan's Street", "Germany", admins, tables));
